...
//        $$(addressesContainer.getSearchCriteria() +" h3" ).findBy(exactText(Neodymium.localizedText("footer.address.germany"))).shouldBe(visible);
        ...
        $$(footerInformationContainer.getSearchCriteria() +" div ul li a").findBy(exactText(Neodymium.localizedText("footer.linkTexts.aboutUs"))).shouldBe(visible);
        $$(footerInformationContainer.getSearchCriteria() +" div ul li a").findBy(exactText(Neodymium.localizedText("footer.linkTexts.contact"))).shouldBe(visible);
        $$(footerInformationContainer.getSearchCriteria() +" div ul li a").findBy(exactText(Neodymium.localizedText("footer.linkTexts.services"))).shouldBe(visible);
        $$(footerInformationContainer.getSearchCriteria() +" div ul li a").findBy(exactText(Neodymium.localizedText("footer.linkTexts.xlt"))).shouldBe(visible);
        $$(footerInformationContainer.getSearchCriteria() +" div ul li a").findBy(exactText(Neodymium.localizedText("footer.linkTexts.references"))).shouldBe(visible);
        $$(footerInformationContainer.getSearchCriteria() +" div ul li a").findBy(exactText(Neodymium.localizedText("footer.linkTexts.privacy"))).shouldBe(visible);
        $$(footerInformationContainer.getSearchCriteria() +" div ul li a").findBy(exactText(Neodymium.localizedText("footer.linkTexts.blog"))).shouldBe(visible);
        $$(footerInformationContainer.getSearchCriteria() +" div ul li a").findBy(exactText(Neodymium.localizedText("footer.linkTexts.xing"))).shouldBe(visible);
        $$(footerInformationContainer.getSearchCriteria() +" div ul li a").findBy(exactText(Neodymium.localizedText("footer.linkTexts.linkedin"))).shouldBe(visible);
        $$(footerInformationContainer.getSearchCriteria() +" div ul li a").findBy(exactText(Neodymium.localizedText("footer.linkTexts.twitter"))).shouldBe(visible);
        $$(footerInformationContainer.getSearchCriteria() +" div ul li a").findBy(exactText(Neodymium.localizedText("footer.linkTexts.github"))).shouldBe(visible);
